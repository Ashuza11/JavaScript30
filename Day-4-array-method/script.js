...
const people = [
    ...
    'Blake, William', 'Blake, William', 'Berger, Ric', 'Beddoes, Mick', 'Beethoven, Ludwig',
...
// make it with an erow function 

// const fifteen = inventors.filter(invetor => {
//     if (invetor.year >= 1500 && invetor.year <= 1600) {
//         return true //keep it! 
//     }
// });
...
// 4. How many years did all the inventors live? using the reduce method
...
// Short way using arrow function and ternary operator
